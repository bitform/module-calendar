...
$MODULE["nav"] = array(
  ...
  "phrase_event_categories"   => array('{$module_dir}/categories.php', false),
  "word_settings" => array('{$module_dir}/settings.php', false),
  "phrase_arbitrary_events" => array('{$module_dir}/settings.php?page=arbitrary', true),
  "phrase_fixed_events"     => array('{$module_dir}/settings.php?page=fixed', true),
